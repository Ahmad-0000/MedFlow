...
def add_answer_comment(a_id):
    ...
    return render_template("add_answer_comment.html", a_id=a_id, cache_id=cache_id)
...
def update_answer_comment(a_id, c_id):
    ...
    return render_template("update_acomment.html", a_id=a_id, c_id=c_id, cache_id=cache_id)
