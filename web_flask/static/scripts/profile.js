...
$(function () { 
    ...
    let answerIndex = 0;
    $.ajax({
          url: `http://localhost:8080/api/v1/users/${userId}/questions/${questionIndex}`,
          type: 'GET',
                      ...
                      if (questions.length > 0) {
                                ...
                                for (const q of questions) {
                                    questionsContainer.append(`
                                                  <div class="question">
                                                    <h3><a href="http://localhost:5000/questions/${q.id}">${q.title}</a></h3>
          ...
          // Populate User's Answers Section
                ...
                $.ajax({
                  url: `http://localhost:8080/api/v1/users/${userId}/answers/${answerIndex}`,
                  type: 'GET',
                      ...
                      for (const a of answers) {
                        answersContainer.append(`
                            <div class="answer" id="${a.id}">
                              <p>For: <a href="http://localhost:5000/questions/${a.question_id}" class="${a.question_id}-question-link"></a></p>
                        ...
                        `)
                        $.ajax({
                          url: `http://localhost:8080/api/v1/questions/${a.question_id}`,
                          type: 'GET',
                          success: function (q) {
